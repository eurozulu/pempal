...
//	"github.com/eurozulu/pempal/prompts"
...
//)
//
//var defaultFieldsForTypes = map[prompts.ResourceType]string{
//	prompts.Unknown:            "resource-type,identity,subject.common-name,location",
//	prompts.Certificate:        "identity,version[7],serial-number,subject.common-name[30],issuer.common-name[30],not-before,not-after,location",
//	prompts.CertificateRequest: "identity,version[7],subject.common-name,location",
//	prompts.PrivateKey:         "identity,public-key-algorithm,key-param,is-encrypted,location",
//	prompts.PublicKey:          "identity,public-key-algorithm,location",
//	prompts.RevokationList:     "identity,issuer.common-name,number,this-update,next-update,location",
//}
//
...
//
//	ResourceTypes []prompts.ResourceType `flag:"-"`
//	columnWidths  []int
...
//		rt := prompts.ParseResourceType(r)
//		if rt == prompts.Unknown {
